        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <address><?php the_field('adress_2', 149); ?></address>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:+<?php the_field('tel_1', 149); ?>">+<?php the_field('tel_1', 149); ?></a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Телефон №2
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:+<?php the_field('tel_2', 149); ?>">+<?php the_field('tel_2', 149); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__mail">
                        Или напишите нам на почту
                        <a href="mailto:<?php the_field('mail', 149); ?>"><?php the_field('mail', 149); ?></a>
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="151" title="Форма отзывов"]'); ?>
                </div>
